...
= 2.2.8 - 9/11/18 =
* Fix issue with updating theme because of version mismatch.

= 2.2.7 - 8/27/18 =
* Fix WooCommerce template update notice.

= 2.2.6 - 5/1/18 =
* Account for sticky posts on the homepage.
* Improve link styles in lists.
* Improve display of audio and video player.
* Files modified: style.scss, style.css, readme.txt, template-parts/content-blog.php, js/customizer.js, inc/customizer.php

= 2.2.5 - 4/6/18 =
* Fixed padding on homepage when using standard pages.
* Files modified: style.scss, style.css, readme.txt, templates/template-homepage.php

= 2.2.4 - 2/17/18 =
* Added pagination to custom blog template.
* Files modified: style.scss, style.css, readme.txt, template-parts/content-blog.php

= 2.2.3 - 2/8/18 =
* Improved support for WooCommerce after latest update.
* Files modified: style.scss, style.css, readme.txt, woocommerce/woo-functions.php

= 2.2.2 - 11/28/17 =
* Improved display of columns on mobile.
* Files modified: style.scss, style.css, readme.txt

= 2.2.1 - 9/6/17 =
* Fixed post_class error that displayed when no featured content was defined.
* Fixed header crop when uploading a header image.
* Improved display of TinyMCE to match front-end post style.
* Files modified: style.scss, style.css, readme.txt, functions.php, inc/jetpack.php, editor-style.css

= 2.1.9 - 9/6/17 =
* Fixed padding when WooCommerce shop page is set to homepage.
* Files modified: style.scss, style.css, readme.txt
