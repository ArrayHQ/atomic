...
(function($){
	...
	wp.customize('atomic_button_color',function(value) {
		value.bind( function( to ) {
			$('button:not(.preview-toggle), input[type="button"], input[type="reset"], input[type="submit"], .button, .comment-navigation a, .drawer .tax-widget a, .su-button, h3.comments-title, .page-numbers.current, .page-numbers:hover, .entry-content p a:hover, .entry-content ul a:hover').css('background-color',to);
		} );
	} );
